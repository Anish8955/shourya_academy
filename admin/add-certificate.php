...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    if ($user->add_certificate($sno, $batch_no, $roll_no, $full_name, $parents_name , $resident_of, $date_of_issue, $designation, $place_of_issue, $training_from, $training_to)) {
      $insert = true;
    } else {
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        if($insert){
          ...
          <strong>Success!</strong> Certificate registered successfully..
     ...
     ?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light"></span> Add Certificate</h4>
